    ...
    protected void configure(HttpSecurity http) throws Exception {
        http	.csrf().disable()
                ...
                .authorizeRequests()
					...
					.antMatchers("/addZac").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteZac").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/updateZac").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteZacApp").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addZacApp").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteApplicationContract").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addApplicationContract").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteApplicationLicense").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addApplicationLicense").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteLicenseApplication").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addLicenseApplication").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteContractApplication").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addContractApplication").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteAppZac").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addAppZac").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addQuestion").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/updateQuestion").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteQuestion").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteQuestionDepartment").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addQeustionDepartment").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deleteDepartmentQuestion").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addDepartmentQeustion").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportstakeholder").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportstakeholder").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportapplication").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportapplication").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/reporttemplateupload").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereporttemplate").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportappinstance").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportappinstance").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportdepartment").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportdepartment").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportzone").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportzone").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportsite").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportsite").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportcompany").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportcompany").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportcontract").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/addreportcontract").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportlicense").hasAnyRole("ADMIN","SYSADMIN","USER")
					...
					.antMatchers("/addreportzac").hasAnyRole("ADMIN","SYSADMIN","USER")
					.antMatchers("/deletereportparemeter").hasAnyRole("ADMIN","SYSADMIN","USER")
